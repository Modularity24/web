...
cat_select	//new for categories select list
...
/*			array( "name" => "general-2",
		...
		array( "name" => "general-1",
			...
			array( "name" => "Theme Stylesheet",
				   ...
				   "type" => "select",
				   "std" => "default.css",
				   "options" => array("default.css","green.css","orange.css","red.css"),
			...
			array( "name" => "Enable Text Logo	(Site Title,Tagline)",
	...
	array( "name" => "nav-navigation",
		...
		array( "name" => "navigation-1",
			...
			array( "name" => "Exclude pages from the page menu",
				   ...
				   "type" => "checkboxes",
				   "std" => "",
				   "desc" => "Here you can choose to remove certain pages from the top menu. All pages marked with an X will not appear in your navigation bar. ",
				   "usefor" => "pages",
				   "options" => $pages_ids),
...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "nav-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Enable slogan on homepage",
            	   "id" => $shortname."_slogan_enable",
            	   "type" => "checkbox2",
                   "std" => "on",
			       "desc" => "desc"),

			array( "name" => "Input slogan content",
            	   "id" => $shortname."_slogan_content",
            	   "type" => "textarea",
                   "std" => "<h1>Your business made easy.</h1><p>We work with thousands of the world's leading brands, agencies &amp; freelancers. Take a goose at our <a href=\"#\">recent work</a> or <a href=\"#\">get in touch</a> for a quick chat.</p>",
			       "desc" => "desc"),

			array( "name" => "Enable featured slider on homepage",
            	   "id" => $shortname."_featured_slider_enable",
            	   "type" => "checkbox2",
                   "std" => "on",
			       "desc" => "desc"),

			array( "name" => "Transition effect of featured slider",
				   "id" => $shortname."_featured_slider_effect",
				   "type" => "select",
				   "std" => "fade",
				   "options" => array("fade", "slide"),
				   "desc" => "desc",),			       

			array( "name" => "Enable portfolio section (recent work) on homepage",
            	   "id" => $shortname."_home_portfolio_enable",
            	   "type" => "checkbox2",
                   "std" => "on",
			       "desc" => "desc"),

			array( "name" => "Heading text of portfolio section",
            	   "id" => $shortname."_home_portfolio_heading",
            	   "type" => "text",
                   "std" => "Recent Work",
			       "desc" => "desc"),		       			       	

			array( "name" => "Number of portfolio items to show on homepage",
            	   "id" => $shortname."_home_portfolio_num",
            	   "type" => "textlimit",
                   "std" => "9",
			       "desc" => "desc"),

			array( "name" => "Enable posts section (team blog) on homepage",
            	   "id" => $shortname."_home_posts_enable",
            	   "type" => "checkbox2",
                   "std" => "on",
			       "desc" => "desc"),

			array( "name" => "Heading text of posts section",
            	   "id" => $shortname."_home_posts_heading",
            	   "type" => "text",
                   "std" => "Team Blog",
			       "desc" => "desc"),		       			       	

			array( "name" => "Number of posts to show on homepage",
            	   "id" => $shortname."_home_posts_num",
            	   "type" => "textlimit",
                   "std" => "9",
			       "desc" => "desc"),

			array( "name" => "Enable testimonials section (happy clients) on homepage",
            	   "id" => $shortname."_home_testimonials_enable",
            	   "type" => "checkbox2",
                   "std" => "on",
			       "desc" => "desc"),

			array( "name" => "Heading text of testimonials section",
            	   "id" => $shortname."_home_testimonials_heading",
            	   "type" => "text",
                   "std" => "Happy Clients",
			       "desc" => "desc"),				       

			array( "name" => "Number of testimonials to show on homepage",
            	   "id" => $shortname."_home_testimonials_num",
            	   "type" => "textlimit",
                   "std" => "3",
			       "desc" => "desc"),			       			       			       			       				       			       			       		       
		...
		array( "name" => "layout-2",
			...
			array( "name" => "Show comments on pages",
            	   ...
            	   "type" => "checkbox2",
                   "std" => "false",
			       "desc" => "You can disable this option if you want to remove the comments and comment form from single pages. "),
			array( "type" => "clearfix",),			
