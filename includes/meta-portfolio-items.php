...
$meta_box = array(
	...
	array(
			...
			'desc' => __('940px x unlimited', 'themejunkie'),
...
$meta_box_portfolio_video = array(
	...
	'fields' => array(
        array( "name" => __('Video Embedded Code','themejunkie'),
				"desc" => __('best width: 940px','themejunkie'),
...
$meta_box_info = array(
	...
	'fields' => array(
    array(
			'name' =>  __('Short Description', 'themejunkie'),
			'desc' => 'A short description of the project.',
			'id' => $prefix.'portfolio_short_desc',
			'type' => 'text',
			'std' => ''
		),
    array(
			'name' =>  __('Client Name', 'themejunkie'),
			'desc' => 'The client name of the project.',
...
function tj_show_box_portfolio() {
	...
	echo '<p style="padding:10px 0 0 0;">'.__('Upload an image and then click "insert into post". To delete an image, simply clear the field.', 'junkie').'</p>';
...
function tj_admin_scripts_portfolio() {
	...
	wp_register_script('tj-upload', get_template_directory_uri() . '/js/upload-button.js', array('jquery','media-upload','thickbox'));
