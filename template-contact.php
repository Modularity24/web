...
if(isset($_POST['submitted'])) {
		...
		if(!isset($hasError)) {
			$emailTo = get_option('estudio_email');
	            ...
	            <?php } else { ?>
	                ...
	                <form action="<?php the_permalink(); ?>" id="contact-form" method="post">
	                    <div class="contact-form">
	                        <div><label for="contactName"><?php _e('Name:', 'themejunkie') ?></label>
	                        ...
	                        <div><label for="email"><?php _e('Email:', 'themejunkie') ?></label>
	                        ...
	                        <div class="textarea"><label for="commentsText"><?php _e('Message:', 'themejunkie') ?></label>
	                        ...
	                        <div>
	                            ...
	                            <input name="submit" type="submit" id="submit" class="button" value="<?php _e('Send Email', 'themejunkie') ?>" />
	                        </div>
	                    </div>
	                </form>
	            <?php } ?>
